...
function addDisclaimer() {
    ...
    disclaimer.innerHTML = `
        <h2>Disclaimer</h2>
        <p>Information on this webpage is not intended to replace professional medical advise
        <p>Please note that estimated fetal weight (EFW) percentile calculations may exhibit slight variations when comparing:</p>
        <ol>
            <li>Values generated by ultrasound equipment</li>
            <li>Percentiles presented in Table 1 of the referenced publication</li>
            <li>Calculations performed by this platform</li>
        </ol>
        <p>These minor discrepancies can be attributed to certain inconsistencies within the original Hadlock paper</p>
        </p>
    `;
